...
final class Catalogs: ObservableObject {
    ...
    static let fallbackExercises: [ExerciseItem] = [
        ...
        .init(id: 7, name: "웨이트 (보통)", met: 3.5, bodyPart: "상체", mode: "strength"),
        .init(id: 8, name: "웨이트 (고강도)", met: 6.0, bodyPart: "상체", mode: "strength"),
        .init(id: 9, name: "스쿼트·런지", met: 5.0, bodyPart: "하체", mode: "strength"),
